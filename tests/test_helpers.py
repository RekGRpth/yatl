...
from yatl.helpers import DIV, SPAN, TAG, XML
...
class TestHelpers(unittest.TestCase):
    def test_tags(self):
        ...
        self.assertEqual(
            DIV(
                _id="my_id", _none=None, _false=False, without_underline="serius?"
            ).xml(),
            '<div id="my_id"></div>',
        )
        self.assertEqual(
            DIV("<b>xmlscapedthis</b>").xml(),
            "<div>&lt;b&gt;xmlscapedthis&lt;/b&gt;</div>",
        )
        self.assertEqual(
            DIV(XML("<b>don'txmlscapedthis</b>")).xml(),
            "<div><b>don'txmlscapedthis</b></div>",
        )
    ...
    def test_amend(self):
        ...
        self.assertEqual(div.xml(), '<div class="myclass" id="myid">hello world</div>')
    ...
    def test_sanitize(self):
        ...
        for x in permitted_tags:
            ...
            if (
                x == "img/"
            ):  # alt or src attribute is required. src has to have a valid href
        ...
        self.assertEqual(
            XML(
                TAG["a"]("oh no!", _href="invalid_link").xml(),
                sanitize=True,
                permitted_tags=["a"],
            ).xml(),
            "oh no!",
        ...
        self.assertEqual(
            XML(
                TAG["a"](TAG["img/"](_src="/index.html"), _class="teste").xml(),
                sanitize=True,
                permitted_tags=["a", "img/"],
            ).xml(),
            '<img src="/index.html"/>',
        )
        ...
        self.assertEqual(
            XML(TAG["img/"]().xml(), sanitize=True, permitted_tags=["img"]).xml(), ""
        )
        self.assertEqual(
            XML(
                TAG["img/"](_src="invalid_url").xml(),
                sanitize=True,
                permitted_tags=["img"],
            ).xml(),
            "",
        ...
        self.assertEqual(
            XML(
                TAG["img/"](_class="teste").xml(), sanitize=True, permitted_tags=["img"]
            ).xml(),
            "",
        )
        self.assertEqual(
            XML(
                TAG["a"](_href="invalid_link").xml(),
                sanitize=True,
                permitted_tags=["a"],
            ).xml(),
            "",
