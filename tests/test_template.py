...
class TestTemplate(unittest.TestCase):
    ...
    def testWithDummyFileSystem(self):
        ...
        self.assertEqual(
            render(
                filename=pjoin("views", "default", "index.html"),
                path="views",
                reader=dummy_open,
            ),
            "left to right",
        ...
        self.assertEqual(
            render(
                filename=pjoin("views", "default", "indexbrackets.html"),
                path="views",
                delimiters="[[ ]]",
                reader=dummy_open,
            ),
        ...
        self.assertEqual(
            render(
                filename=pjoin("views", "default", "noescape.html"),
